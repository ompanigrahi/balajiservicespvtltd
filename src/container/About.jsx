        ...
        <div className="flex flex-wrap justify-center items-center gap-12 px-6 pb-10">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 text-left text-green-900">
            <h2 className="text-2xl font-bold mb-4">
              Welcome to Balaji Services
            </h2>
            <p className="text-lg leading-7">
              <strong className="text-green-800 underline">
                Balaji Services
              </strong>{" "}
              is your trusted partner for top-tier home and garden maintenance
              solutions. Our experienced team provides tree cutting for safety
              and beauty, house coloring for a refreshed appearance, and
              housekeeping for a pristine home. We also specialize in plot
              cleaning, garden maintenance, and grass cutting, ensuring a
              well-groomed and healthy landscape.
            </p>
            <p className="text-lg leading-7 mt-4">
              With a commitment to excellence, efficiency, and customer
              satisfaction, Balaji Services guarantees high-quality services
              tailored to your needs. Let us help you create a clean, vibrant,
